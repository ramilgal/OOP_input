...
public class Main {
    public static void main(String[] args) {
        ...
        Car car1 = new Car("Lada", "Granta", 1.8D);
        Car car2 = new Car("Audi", "A8 50 L TDI quattro", 3.0D);
        Car car3 = new Car("BMW", "Z8",3.0D);
        Car car4 = new Car("Kia", "Sportage 4", 2.4D);

        Bus bus1 = new Bus("Нефаз", "Городской", 4.0);
        Bus bus2 = new Bus("Белфаз>", "Первый", 4.3);
        Bus bus3 = new Bus("Икарус", "Второй", 4.2);
        Bus bus4 = new Bus("Москвич", "Третий", 4.5);

        Truck truck1 = new Truck("Камаз", "Первый", 5.0);
        Truck truck2 = new Truck("Камаз", "Второй", 5.5);
        Truck truck3 = new Truck("Камаз", "Третий", 5.8);
        Truck truck4 = new Truck("Камаз", "Четвертый", 5.2);
