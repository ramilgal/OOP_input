...
public class Main {
    public static void main(String[] args) {
        ...
        Car car4 = new Car("Kia", "Sportage 4", 2018, "Южная Корея", "Красный", 2.4D, "Автомат", "Кроссовер", "У444УУ 116", 5, true, new Car.Key(true, false));
        Car car5 = new Car("Hyundai", "Avante", 2016, "Южная Корея", "Оранжевый", 1.6D, "Автомат", "Седан", "У555УУ 116", 5, false, new Car.Key(true, false));
